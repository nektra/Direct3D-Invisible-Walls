...
namespace DeviareTest
{
    public partial class Form1 : Form
    {
        ...
        {
            _spyMgr.LoadCustomDll(_process, @"..\..\..\Plugin\bin\Plugins\CRegistryPlugin64.dll", false, false);

            pipe = new NamedPipeClientStream(".", "HyperPipe64", PipeDirection.InOut);
            pipe.Connect();

            byte[] data = new byte[8];
            pipe.Read(data, 0, 8);
            Int64 address = BitConverter.ToInt64(data, 0);
            ...
            hook.AddCustomHandler(@"..\..\..\Plugin\bin\Plugins\CRegistryPlugin64.dll", 0);
